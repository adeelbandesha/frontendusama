...
export const categoriesPrices = {
    ...
    painting: [
        ...
        },
        {
            ...
            vm: "Villa" ,
            onSurvey: true,
            reason: 'type of door(s)?',
            reasons: ['metal', 'wooden', 'fibreglass', 'UPCV', 'other'],
        ...
        },
        {
            ...
            vm: "Villa" ,
            onSurvey: true,
            reason: 'What type of furniture?',
            reasons: ['small item e.g chairs', 'medium item e.g tables', 'large item e.g cupboards', 'other'],
            unit: "How many units?",
            units: 1,
            additional: "Furniture broken or required repair?",
        },
        {
            name: 'interior-single-coat',
            price: 570,
            unis:1,
            uni: "how many rooms",
            rooms: ['1 ', '2', '3 ','4','5',],
        ...
        },
        {
            ...
            rooms: ['1 ', '2', '3 ','4','5',],
            onSurvey: true,
            reason: 'What is the wall type?',
            reasons: ['gympsum', 'concrete', 'normal cement', 'combination of materials', 'other'],
            unit: "How much area (sqm)?",
            units: 25,
            additional: "Wallpaper repair or preparation required?"
        },
        {
    ...
    deepcleaning: [
        {
            ...
            reasons: ['regular cleaning','pre party cleaning', 'post party cleaning', 'other'],
            rooms: ['1 ', '2', '3 ','4','5',],
        ...
        {
            name: 'villa-or-appartment-cleaning',
            uni:"How many rooms ?",
            price: 154,
            rooms: ['1 ', '2', '3 ','4','5',],
            am: "Apartment" ,
