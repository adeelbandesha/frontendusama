...
export const categoriesPrices = {
    ...
    painting: [
       
        {
            ...
            text1: '1 Bedroom Apartment',
            text2: '2 Bedroom Apartment',
            text3: '3 Bedroom Apartment',
            text4: '4 Bedroom Apartment',
            prz: '650',
            prz1: '830',
            prz2: '1300',
            prz3: '1900',
            ...
            texta1: '2 Bedroom Villa',
            texta2: '3 Bedroom Villa',
            texta3: '4 Bedroom Villa',
            texta4: '5 Bedroom Villa',
            prz1a: '1799',
            prz2a: '2499',
            prz3a: '3100',
            prz4a: '3900',
            ...
            texti1: 'No. ceiling painting',
            texti2: 'No. Bedroom painting',
            texti3: 'No. Kitchen',
            texti4: 'No. dining room',
            ...
            uni: "Villa",
            rooms: ['Highly Recommended for in and out ' , 'color Paint Included',],
            price: 0,
            unis:1,
            onSurvey: false,
            reason: 'Appartment',
            reasons: ['Highly Recommended for in and out ' , 'color Paint Included'],
            rea: 'Individual Area painting',
            reas: ['Highly Recommended for in and out ' , 'color Paint Included'],
        ...
        },
        {
            ...
            additionalChargesmaid: 79,
            uni: "Villa",
            rooms: ['Highly Recommended for in and out '],
            price: 0,
            unis:1,
            onSurvey: false,
            reason: 'Appartment',
        ...
        },
        {
            ...
            additionalChargesmaid: 79,
            uni: "Villa",
            rooms: ['Highly Recommended for in and out ' , 'White/offwhite Paint Included',],
            price: 0,
            unis:1,
            onSurvey: false,
            reason: 'Appartment',
            reasons: ['Highly Recommended for in and out ' , 'White/offwhite Paint Included'],
            rea: 'Individual Area painting',
            reas: ['Highly Recommended for in and out ' , 'White/offwhite Paint Included'],
            unit: "How many door(s)?",
            units: 1,
            additional: "Is painting required both sides?"
        },
    ...
    deepcleaning: [
        ...
        },
        {
            ...
            vm: "Villa" ,
            onSurvey: false,
            reason: 'Reason for cleaning?',
            reasons: ['stains','dusty not used for long', 'regular cleaning', 'post pest control cleaning', 'other'],
            unit: "How many Maids you want?",
            units: 1,
            unis:1,
        ...
        },
        {
            ...
            price: 0.00,
            onSurvey: true,
            reason: 'Type of floor?',
            reasons: ['ceramics tyles','marble', 'brick', 'other'],
            unit: "How many Maids you want?",
            units: 1,
            unis:1,
        ...
        },
        {
            ...
            onSurvey: true,
            reason: 'Reason for cleaning?',
            reasons: ['rains','too dirty from sand', 'regular cleaning', 'other'],
            unit: "How many Maids you want?",
            units: 1,
            unis:1,
        ...
        //     vm: "Villa" ,
        //     onSurvey: false,
        //     reason: 'What type of curtains?',
        //     reasons: ['cotton','syntheric', 'silky', 'other'],
        //     unit: "How many Maids you want?",
        //     units: 1,
        ...
        // },
        {
            ...
            onSurvey: false,
            reason: 'Reason for cleaning?',
            reasons: ['stains','dust, not used for long', 'regular cleaning', 'other'],
            unit: "How many Maids you want?",
            units: 1,
            unis:1,
            additional: "Need steam cleaning?",
        ...
        },
         {
            ...
            am: "Apartment" ,
            vm: "Villa" ,
            uni:"How many Carpets?",
            rooms: ['1 ', '2', '3 ','4','5',],
            onSurvey: false,
            reason: 'Reason for cleaning?',
            reasons: ['stains','dust, not used for long', 'regular cleaning', 'post pest control cleaning', 'other'],
            unit: "How many Maids you want?",
            units: 1,
            unis:1,
            additional: "Need steam cleaning?",
        ...
        },
        {
            ...
            vm: "Villa" ,
            onSurvey: false,
            reason: 'Reason for deep cleaning?',
            reasons: ['moving out deepclean','moving in deepclean', 'regular deepclean', 'post construction deepclean', 'other'],
            unit: "How many rooms?",
            units: 1,
            additional: "Is this a furnished location?",
            additionalChargesmaid: 79,
        ...
        //     onSurvey: true,
        //     reason: 'What is the requirement?',
        //     reasons: ['post construction cleaning','roof drain unblocking', 'junk removal', 'drain or sewer cleaning', 'other'],
        //     unit: "How many Maids you want?",
        //     units: 1,
        //     additionalChargesmaid: 79,
        //     additional: "Is this a furnished location?"
